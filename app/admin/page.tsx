...
export default async function AdminPage({ searchParams }: { searchParams: { sent?: string } }) {
  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-md py-12">
        ...
        {searchParams.sent ? <p className="mt-3 rounded-lg border border-accent/30 bg-accent/10 p-3 text-sm text-accent">Перевір пошту для magic link.</p> : null}
